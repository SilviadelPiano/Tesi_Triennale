...
\lstinputlisting[language=HAML, style=CSS, caption=views/layouts/application.html.haml, label=lst:application_layout]{code/application.html.haml}

\lstset{language=CSS, , captionpos=b, frame=single}
\lstinputlisting[language=CSS, style=CSS, caption=assets/stylesheets/application.css.scss, label=lst:application_css]{code/application.css.scss}
